...
//			System.out.print("Working or not???");	
...
public static void main(String[] args) {
    ...
    try {
        ...
        vmList = new ArrayList<Vm>();
        for (int i = 0; i < 500; i++) {
            Vm vm = new Vm(i, brokerId, 250, 1, 512, 1000, 10000, "Xen", new CloudletSchedulerTimeShared());
            vmList.add(vm);
        }
        broker.submitVmList(vmList);
        ...
        // Retrieve and print the list of received cloudlets
        List<Cloudlet> newList = broker.getCloudletReceivedList();
        printCloudletList(newList);
